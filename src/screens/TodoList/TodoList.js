            ...
            >
                ...
                >
                    <Query
                        ...
                        onChangeQueryDone={this.onChangeQueryDone}
                    />
                    <div
                        style={{
                            marginTop: 3,
                    ...
                    >
                        {this.state.list.filter(this.filter).map(this.ToDo)}
                    </div>
                </div>
            </div>
        );
                ...
                >
                    ...
                    >
                        <Button
                            ...
                            text={"Edit"}
                            onClick={this.onClickEditTodo(todo.id)}
                        />
                        <RemoveButton
                            onClickRemove={this.onClickRemoveTodo(todo.id)}
                        />
                        <Button
                            style={{
                                fontSize: 15,
                        ...
                        <Button
                            ...
                            onClick={this.onClickMoveDown(todo.id)}
                        />
                    </div>
                    <Button
                        style={{
